...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    member: Schema.Attribute.Relation<'oneToOne', 'api::team.team'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDizajnProektDizajnProekt extends Struct.SingleTypeSchema {
  collectionName: 'dizajn_proekts';
  info: {
    description: '';
    displayName: '\u0414\u0438\u0437\u0430\u0439\u043D \u043F\u0440\u043E\u0435\u043A\u0442';
    pluralName: 'dizajn-proekts';
    singularName: 'dizajn-proekt';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dizajn-proekt.dizajn-proekt'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<['media.3-d-tour', 'media.gallery']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dizajn-proekt.dizajn-proekt': ApiDizajnProektDizajnProekt;
